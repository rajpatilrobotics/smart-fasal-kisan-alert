...
describe('RSK in-memory identity bridge', () => {
  it('reacts to the ready event and accepts only a memory-persistent bridge', async () => {
    const createReturnState = vi.fn().mockResolvedValue('00000000-0000-4000-8000-000000000102');
    ...
    expect(signIn).toHaveBeenCalledWith({
      returnStateId: '00000000-0000-4000-8000-000000000102',
      surface: 'rsk',
    });
  });
});
