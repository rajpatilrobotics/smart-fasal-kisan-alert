...
import { createMpReturnState, establishMpRole, type ShellIssue } from '../lib/mp-api';
...
interface MpAuthGatewayProps {
  readonly createReturnState?: typeof createMpReturnState;
  readonly establishRole?: typeof establishMpRole;
}

export function MpAuthGateway({
  createReturnState = createMpReturnState,
  establishRole = establishMpRole,
}: MpAuthGatewayProps = {}) {
