...
export type IdentityBridge = BrowserIdentityBridge<'mp'>;
...
const firebaseIdentityBridge =
  typeof window === 'undefined'
    ...
    : createFirebaseIdentityBridge({
        surface: 'mp',
        environment: process.env.NEXT_PUBLIC_MP_SMART_FASAL_ENVIRONMENT,
        apiKey: process.env.NEXT_PUBLIC_MP_FIREBASE_API_KEY,
        authDomain: process.env.NEXT_PUBLIC_MP_FIREBASE_AUTH_DOMAIN,
        projectId: process.env.NEXT_PUBLIC_MP_FIREBASE_PROJECT_ID,
        appId: process.env.NEXT_PUBLIC_MP_FIREBASE_APP_ID,
        appCheckEnterpriseSiteKey: process.env.NEXT_PUBLIC_MP_FIREBASE_APPCHECK_ENTERPRISE_SITE_KEY,
      });
